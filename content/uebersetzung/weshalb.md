...
description: Silashin Sabbamitta, 2020
img: newpath.png
...
- Ein weiterer Punkt ist, dass in der Sprache des Palikanons das männliche Geschlecht stark dominiert und häufig den Eindruck erweckt, die meisten Suttas seien auschließlich an (männliche) Mönche adressiert gewesen, was aber nicht notwendigerweise der Fall ist.
  ...
  Da die deutsche Sprache keine einfache und elegante Lösung zur geschlechtsneutralen Beschreibung von Personen zur Verfügung hat, nutze ich entweder Doppelnennungen („Mönche und Nonnen“) oder wechsele ab (einmal „Mönch“, einmal „Nonne“).
...
Zusätzlich ermöglicht das von Karl Lew entwickelte und auch in Voice.suttacentral.net genutzte [SCV-bilara](https://github.com/sc-voice/scv-bilara) eine dreisprachige Suchfunktion, die ebenfalls sehr hilfreich ist.

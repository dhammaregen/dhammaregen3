...
*(Bemerkung: Suttas, die noch nicht von Silashin Sabbamitta übersetzt wurden, werden ersatzweise auf Englisch angezeigt; Sie können über den SuttaCentral-Link am Fuß jeder Suttakarte zu einer deutschen Übersetzung auf SuttaCentral gelangen.)*
...
### 4. Sie kennen: das Ratana-Sutta über die drei Juwelen (--> [Snp 2.1](#/sutta/snp2.1/de/sabbamitta) und --> [Kp 6](#/sutta/kp6/de/sabbamitta))
...
### Warum lesen Sie nicht: das Sela-Sutta über Hingabe an den Buddha (--> [MN 92](#/sutta/mn92/de/sabbamitta))
...
### 5. Sie kennen: das Tirokuṭṭa-Sutta über Spenden (--> [Kp 7](#/sutta/kp7/de/sabbamitta))
...
### 6. Sie kennen: das Satipaṭṭhāna-Sutta über Achtsamkeitsmeditation (--> [MN 10](#/sutta/mn10/de/sabbamitta))
